#PURPOSE: Find the minimum value of the numbers in a list.
#

#VARIABLES: The registers have the following uses:
#
# %edi - Holds the index of the data item to be examined
# %ebx - Minimum data item found
...
data_items:		#These are the data items. Note that 0 is the end.
	.long 3,67,34,245,45,1,54,34,44,33,22,11,66,0
...
start_loop:
	...
	jge start_loop			# jump to loop beginning if new one isn'					# bigger
